...
```{r}
GILCAP <- GILCAP %>%
  rename(OSeeds_Per_Bloom = OSeeds_Per_bloom,
...
All_Cleaned_Data <- rbind(GILCAP, MICGRA,GLTCCOLLIGRA, cleaned_GLTC_MADGRA,cleaned_WWCLAAMO, cleaned_WWCLAPUR, cleaned_WWCOLLIGRA)
write.csv(All_Cleaned_Data, "/Users/isabellenollette/Desktop/final_community_assembly-SJIN/data/All_Cleaned_Data")
```
