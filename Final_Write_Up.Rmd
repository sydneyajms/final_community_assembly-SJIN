...
Thus, knowing which of these interactions will promote positive species coexistence by enhancing reproductive success is critical to ensuring population persistence in the face of an ever-changing environment (@moeller_pollinator_2005). 
...
Many of these studies explore the dynamics of these plant-pollinator interactions as a driver of species richness (@memtsas_what_2022), where the objective is often community resilience to an external stressor. Such resiliance is usually correlated to the structure of specialists and generalists of both plants and pollinators within a community. Abundance of generalist pollinators is often high (@moeller_pollinator_2005) and advances the transfer of pollen between plants; however, some degree of specialisation is necessary for successful pollination for flowers requiring conspecific pollen (Brosi). This characteristic of community structure is usually defined as the level of nestedness - the tendency for specialists to interact with subsets of the species that generalists interact with. It is thought that a perfectly nested community is the most resilient (@brosi_pollinator_2016). Highly specialised systems like the fiscus trees and their wasp pollinators experience a trade-off between high reproductive success and low resilience, therefore experiencing a low level of nestedness. 
